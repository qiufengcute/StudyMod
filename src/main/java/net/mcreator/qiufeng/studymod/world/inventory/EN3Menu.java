...
public class EN3Menu extends AbstractContainerMenu implements StudymodModMenus.MenuAccessor {
	...
	public EN3Menu(int id, Inventory inv) {
	...
	public EN3Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		this(id, inv, new SimpleContainer(0), extraData);
	}

	public EN3Menu(int id, Inventory inv, Container container, FriendlyByteBuf extraData) {
	...
	public EN3Menu(int id, Inventory inv, Container container) {
		super(StudymodModMenus.EN_3, id);
	...
	public static void screenInit() {
		PayloadTypeRegistry.playC2S().register(EN3ButtonMessage.TYPE, EN3ButtonMessage.STREAM_CODEC);
		ServerPlayNetworking.registerGlobalReceiver(EN3ButtonMessage.TYPE, EN3ButtonMessage::handleData);
	}
}