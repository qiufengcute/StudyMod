...
public class EN2Menu extends AbstractContainerMenu implements StudymodModMenus.MenuAccessor {
	...
	public EN2Menu(int id, Inventory inv) {
	...
	public EN2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		this(id, inv, new SimpleContainer(0), extraData);
	}

	public EN2Menu(int id, Inventory inv, Container container, FriendlyByteBuf extraData) {
	...
	public EN2Menu(int id, Inventory inv, Container container) {
		super(StudymodModMenus.EN_2, id);
	...
	public static void screenInit() {
		PayloadTypeRegistry.playC2S().register(EN2ButtonMessage.TYPE, EN2ButtonMessage.STREAM_CODEC);
		ServerPlayNetworking.registerGlobalReceiver(EN2ButtonMessage.TYPE, EN2ButtonMessage::handleData);
	}
}